...
const (
	UserService_GetUserProfile_FullMethodName        = "/spacetime_node.v1.UserService/GetUserProfile"
	UserService_UpdateUserPreferences_FullMethodName = "/spacetime_node.v1.UserService/UpdateUserPreferences"
)
...
type UserServiceClient interface {
	// GetUserProfile returns the demo user's profile and persisted preferences.
	GetUserProfile(ctx context.Context, in *GetUserProfileRequest, opts ...grpc.CallOption) (*GetUserProfileResponse, error)
	// UpdateUserPreferences replaces the persisted preference document.
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "spacetime_node.v1.UserService",
	...
	Metadata: "api/proto/spacetime_node/v1/user.proto",
}
