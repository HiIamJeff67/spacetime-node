...
func resetDatabase(t *testing.T, db *sql.DB) {
	...
	for _, name := range []string{"000001_core.sql", "000002_demo_seed.sql", "000008_offer_category.sql", "000009_user_preference_weights.sql", "000010_demo_station_catalog.sql"} {
